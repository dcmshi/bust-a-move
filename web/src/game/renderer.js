 ...
 *
 * Bubble and shooter sprites are transparent PNGs (generated by
 * convert-assets.js) so they composite cleanly over the background. The
 * remaining UI images (title, lives, backgrounds, game-over) are still
 * opaque BMPs drawn full-frame, where transparency doesn't matter.
 */
